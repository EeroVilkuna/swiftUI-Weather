...
//  SwiftUI-Weather
//
//  Created by Eero Vilkuna on 25.11.2022.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        BackgroundView(isNight: $isNight)
            VStack{
               CityTextView(cityName: "Oulu, WI")
                MainWeatherStatusView(imageName: isNight ? "moon.stars.fill" : "cloud.sun.fill", tempature: 16)
                
                    
                HStack(spacing: 20){
                    WeatherDayView(dayOfWeek: "TUE", imageName: "cloud.sun.fill", temperature: 30)
                    WeatherDayView(dayOfWeek: "WED", imageName: "snowflake", temperature: -5)
                    WeatherDayView(dayOfWeek: "THU", imageName: "cloud.moon.rain.fill", temperature: 3 )
                    WeatherDayView(dayOfWeek: "FRI", imageName: "cloud.sun.rain.fill", temperature: 12)
                    WeatherDayView(dayOfWeek: "SAT", imageName: "cloud.drizzle.fill", temperature: 8)
                }
                Spacer()
